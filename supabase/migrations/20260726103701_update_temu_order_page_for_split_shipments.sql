-- Page and count packages independently while retaining original-order customer
-- identity and refund signals.
...
begin
  ...
  base_lines as (
    select
      ...
      line.shipment_id::text as group_key,
  ...
  stage_primary as (
    ...
    order by line.group_key, line.package_sequence, line.id
  ),
  stage_summary as (
